      ...
      <div className='flex justify-between items-start'>
          <div>
            ...
            <div className='flex items-center self-center gap-3'>
              <Link href = {`/contact/edit/${contact.id}`} className='flex items-center gap-2 px-3 py-1 text-blue-600 border border-blue-300 rounded-md hover:border-blue-400 hover:bg-blue-100'>
